...
public class ShouzuxinxiController {
    ...
    public R page(@RequestParam Map<String, Object> params,ShouzuxinxiEntity shouzuxinxi,
		...
		if(tableName.equals("zuke")) {
			shouzuxinxi.setZhanghao((String)request.getSession().getAttribute("username"));
		}
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,ShouzuxinxiEntity shouzuxinxi, HttpServletRequest request){
        EntityWrapper<ShouzuxinxiEntity> ew = new EntityWrapper<ShouzuxinxiEntity>();
		PageUtils page = shouzuxinxiService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, shouzuxinxi), params), params));
        return R.ok().put("data", page);
    }
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<ShouzuxinxiEntity> wrapper = new EntityWrapper<ShouzuxinxiEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = shouzuxinxiService.selectCount(wrapper);
